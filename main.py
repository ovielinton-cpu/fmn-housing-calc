...
async def build_ui(page: ft.Page):
    ...
    async def build_main_app():
        ...
        async def manage_categories_dialog(e):
            ...
            new_cat_field = ft.TextField(label="New Category Name", bgcolor="#FFFFFF", color="black", text_style=ft.TextStyle(color="black"), capitalization=ft.TextCapitalization.WORDS, dense=True)
        ...
        async def open_ajo_switcher(e):
            ...
            def make_rename_group(target_group):
                def _open_rename(e):
                    rename_field = ft.TextField(value=target_group["name"], bgcolor="#FFFFFF", color=PURPLE_TEXT, text_style=ft.TextStyle(color=PURPLE_TEXT, weight=ft.FontWeight.BOLD), capitalization=ft.TextCapitalization.WORDS, autofocus=True)
                        ...
                        ft.Container(
                            content=ft.Row(
                                [
                                    ...
                                    ft.Row(
                                        [
                                            ft.Text(f"{cycle_count} cycle{'s' if cycle_count != 1 else ''}", color="#888888", size=11),
