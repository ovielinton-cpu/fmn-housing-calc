            ...
            if not active_group.get("order"):
                ...
                for i, m in enumerate(active_group.get("members", [])):
                    ...
                    members_col.controls.append(
                        ft.Row(
                            [ft.Text(m, color="#FFD700", size=15, weight=ft.FontWeight.BOLD), ft.IconButton(icon=ft.Icons.CLOSE, icon_color="#C62828", icon_size=16, on_click=make_remove_member(i))],
                            alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
                        )
                    )
