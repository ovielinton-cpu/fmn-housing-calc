...
async def build_ui(page: ft.Page):
    ...
    async def build_main_app():
        ...
        async def manage_categories_dialog(e):
            ...
            icon_preview = ft.Icon(ft.Icons.HELP_OUTLINE_ROUNDED, color=PURPLE_TEXT, size=22)
            ...
            def make_pick_icon(key):
                def _pick(e):
                    ...
                    icon_preview.name = ICON_PALETTE[key]
                    page.update()
                return _pick

            icon_grid = ft.Row(
                [ft.IconButton(icon=icon_val, icon_color=PURPLE_TEXT, on_click=make_pick_icon(key)) for key, icon_val in ICON_PALETTE.items()],
                wrap=True, spacing=2,
            )
            ...
            async def add_category(e):
                ...
                new_cat_field.value = ""
                selected_icon_key["value"] = None
                icon_preview.name = ft.Icons.HELP_OUTLINE_ROUNDED
            ...
            dlg = ft.AlertDialog(
                ...
                content=ft.Container(
                    content=ft.Column(
                        [
                            ...
                            icon_grid,
                            ft.Row([ft.Text("Selected:", color=PURPLE_TEXT, size=12), icon_preview]),
                            add_error_text,
                ...
                actions=[ft.TextButton("Done", on_click=lambda e: page.pop_dialog(), style=ft.ButtonStyle(color=PURPLE_TEXT))],
                actions_alignment=ft.MainAxisAlignment.END,
            )
            page.show_dialog(dlg)
            ...
            ajo_content_area.content = ft.Container(
                content=ft.Column(
                    [
                        ...
                        ft.ElevatedButton("Advance to Next Round", on_click=advance_round, style=ft.ButtonStyle(bgcolor="#2E8B57", color="white"), disabled=not is_admin or paid_count == 0),
                    ],
                    spacing=10,
                    horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                ),
