...
async def build_ui(page: ft.Page):
    ...
    TUTORIAL_SLIDES = [
        ...
        },
        {
            ...
            "text": "Add Income or Expense entries with a Category (with its own icon), an optional Bank Charge for transfer/POS fees, an optional Note, and a Date — pick one from the calendar, or leave it blank to use today automatically.",
        },
        {
