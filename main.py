            ...
            ajo_content_area.content = ft.Container(
                content=ft.Column(
                    [
                        ...
                        ft.ElevatedButton("Advance to Next Round", on_click=advance_round, style=ft.ButtonStyle(bgcolor="#2E8B57", color="white"), disabled=not is_admin or paid_count < len(payments)),
                    ],
                    spacing=10,
                    horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                ),
