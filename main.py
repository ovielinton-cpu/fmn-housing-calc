...
async def build_ui(page: ft.Page):
    ...
    async def build_main_app():
        ...
        # -------------------- QUICK ADD SHORTCUTS --------------------
        mt_quick_add_row = ft.Row([], spacing=8, scroll=ft.ScrollMode.AUTO)
        ...
        async def manage_quick_add_dialog(e):
            ...
            new_label = ft.TextField(label="Label", bgcolor="#FFFFFF", color=PURPLE_TEXT, text_style=ft.TextStyle(color=PURPLE_TEXT, weight=ft.FontWeight.BOLD), dense=True)
        ...
        mt_quick_add_card = ft.Container(
            content=ft.Column(
                [ft.Text("Quick Add", color="white", weight=ft.FontWeight.BOLD, size=13), mt_quick_add_row],
                spacing=8,
            ),
        ...
        def open_more_options_menu(e):
            ...
            rows = nav_rows + [
                ...
                make_option_row(ft.Icons.FLASH_ON_ROUNDED, "Manage Quick Add Shortcuts", "#2E8B57", manage_quick_add_dialog),
