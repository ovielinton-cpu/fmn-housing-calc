            ...
            if not active_group.get("order"):
                ...
                async def manual_order_dialog(e):
                    ...
                    async def confirm_manual_order(e):
                        if len(selected_order) != len(members):
                            manual_error_text.value = "Tap every member above before confirming."
                            page.update()
                            return
                        page.pop_dialog()
                ...
                async def draw_order(e):
                    ...
                    review_dlg = ft.AlertDialog(
                        ...
                        content=ft.Container(
                            content=ft.Column(
                                [ft.Text("Check the list below for mistakes or missing names before drawing.", color=DARK_TEXT, size=12)] + review_rows,
                                spacing=8, scroll=ft.ScrollMode.AUTO, tight=True,
                            ),
            ...
            ajo_content_area.content = ft.Container(
                content=ft.Column(
                    [
                        ...
                        ft.Container(
                            content=ft.Container(
                                width=220 * countdown_fill_ratio,
                                height=10,
                                bgcolor=countdown_color,
                                border_radius=5,
