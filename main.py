        ...
        async def refresh_ajo_ui():
            ...
            if not active_group.get("order"):
                ...
                def build_starry_background():
                    ...
                    for _ in range(20):
                        star = ft.Container(
                            content=ft.Text(random.choice(star_glyphs), size=random.choice([10, 14, 18, 22])),
                        ...
                        stars.append(star)
                    return stars, ft.Stack(controls=stars, expand=True)

                async def twinkle_stars(stars):
                    try:
                ...
                async def run_the_draw(due_date):
                    ...
                    star_list, starry_stack = build_starry_background()
                    ...
                    page.update()
                    asyncio.create_task(twinkle_stars(star_list))
