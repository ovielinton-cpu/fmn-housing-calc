...
async def build_ui(page: ft.Page):
    ...
    async def build_main_app():
        ...
        mt_type_dropdown = ft.Dropdown(
            options=[
                ft.dropdown.Option(key="income", text="Income", content=ft.Text("Income", color="white", weight=ft.FontWeight.BOLD)),
                ft.dropdown.Option(key="expense", text="Expense", content=ft.Text("Expense", color="white", weight=ft.FontWeight.BOLD)),
            ],
            value="income",
        ...
        page.update()
        asyncio.create_task(animate_logo_loop())
