...
async def build_ui(page: ft.Page):
    ...
    async def build_main_app():
        ...
        mode_badge = ft.Container(
            content=ft.Row(
                [
                    ft.Icon(ft.Icons.DARK_MODE_ROUNDED if is_dark_mode else ft.Icons.LIGHT_MODE_ROUNDED, size=14, color="#FFD700"),
                    ft.Text("Dark Mode" if is_dark_mode else "Light Mode", size=11, weight=ft.FontWeight.BOLD, color="white"),
                ],
